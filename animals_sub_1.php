...
$animals_type_1 = $_GET['type_1']?$_GET['type_1']:1;
$animals_type_2 = $_GET['type_2']?$_GET['type_2']:1;
$animals_type_3 = $_GET['type_3']?$_GET['type_3']:1;
$animals_type_4 = $_GET['type_4']?$_GET['type_4']:1; 
$pageSize = 7;
$offset_animals = ($page_animals - 1)*7;
$sql = "select * from animals where animaltype in ('节肢类','甲壳类','软体类','原生类')";
$result=mysql_query($sql);
$totalRows_animals=mysql_num_rows($result);
$sumPage_animals = ceil($totalRows_animals/$pageSize);
$query_animals = "select * from animals where animaltype in('{$animals_type_1}','{$animals_type_2}','{$animals_type_3}','{$animals_type_4}') order by id desc limit {$offset_animals},{$pageSize}";
        ...
        <div class="banner">
			...
			<div class="container">
                <ul class="bread-crumb">
                    ...
                    <li class="current">无脊椎动物Invertebrates</li>
                </ul>
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_animals;$i++){
    					       echo "<li><a href='animals_sub.php?type={$animals_type}&page_animals={$i}'>$i</a></li>";
