...
$query=mysql_query("select * from say_protection where userid = {$pro_id} order by id desc limit {$offset_say},{$pageSize}");
...
<html lang="zh-cn">
  <head>
    ...
    <script type="text/javascript" src="js/global_pro.js"></script>
			...
			<div class="container">
                ...
                <div class="col-md-9  right-wrap">
                    ...
                    <?php foreach ($rows_pro as $admin):?>
                        <div class="title"><?php echo $admin['name']?></div>
                        <div class="time"><span><?php echo $admin['time']?></span></div>
                        <div class="description"><?php echo $admin['document']?></div>
                    <?php endforeach;?>
                </div>
                <div class="demo col-md-9 col-md-offset-3" style="margin-bottom:30px;">
                    <form id="myform" action="submit_pro.php" method="post">
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_say;$i++){
    					       echo "<li><a href='document_pro.php?page_say={$i}&pro_id={$pro_id}'>$i</a></li>";
