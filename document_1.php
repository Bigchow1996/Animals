...
$query_knowledge = "select * from knowledge order by id asc limit {$offset_knowledge},{$pageSize}";
	  ...
	  <div class="banner">
			...
			<div class="container">
                <ul class="bread-crumb">
                    ...
                    <li class="current">动物知识 Knowledge</li>
                </ul>
                ...
                <div class="col-md-9 right-wrap">
                    ...
                    <ul class="info-list">
                        ...
                        <li class="clearfix">
                            <div class="text-wrap">
                                <h3 class="clearfix"><a href="document_knowledge.php?knowledge_id=<?php echo $admin['id']?>" target="_self"><?php echo $admin['title']?><br></a><span><?php echo $admin['time']?></span></h3>
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_knowledge;$i++){
    					       echo "<li><a href='document_1.php?page_knowledge={$i}'>$i</a></li>";
