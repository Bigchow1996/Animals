...
$query = "select * from say_knowledge where userid = {$knowledge_id} order by id desc limit {$offset_say},{$pageSize}";
        		...
        		<div class="row">
			      ...
			      <div class="col-md-12">
			       <div class='panel panel-default'>
        		    <div class='panel-heading'>修改数据(动物知识)</div>
            	    <div class='changeCon panel-body'>
            	       <form action='change_data/change_knowledge.php' method='post' target='knowledge' class='form-horizontal' role='form'>
                           <div class='form-group'>
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_say;$i++){
    					       echo "<li><a href='change_knowledge.php?page_say={$i}&knowledge_id={$knowledge_id}'>$i</a></li>";
            ...
            <script>
            	  $(function(){
        		        $(".delete").click(function(){
            		        ...
            		        var msg = "您真的确定要删除吗？\n\n请确认！";
            		        if (confirm(msg)==true){
            		        	var url = "delect_data/delect_knowledge.php?say_id_knowledge="+id;
                		        $.get(url);
