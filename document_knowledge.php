...
$link = connect3();
$knowledge_id = $_GET['knowledge_id']?$_GET['knowledge_id']:1;
...
<html lang="zh-cn">
  <head>
    ...
    <script type="text/javascript" src="js/global_knowledge.js"></script>
	  ...
	  <div class="banner">
			...
			<div class="container">
                ...
                <div class="demo col-md-9 col-md-offset-3" style="margin-bottom:30px;">
                    <form id="myform" action="submit_knowledge.php" method="post">
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_say;$i++){
    					       echo "<li><a href='document_knowledge.php?page_say={$i}&knowledge_id={$knowledge_id}'>$i</a></li>";
