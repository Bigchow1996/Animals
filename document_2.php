...
$link = connect3();
$page_text = $_GET['page_text']?$_GET['page_text']:1;
$pageSize = 8;
$offset_text = ($page_text - 1)*8;
$table_text = "text";
$totalRows_text = getTotalRows($link,$table_text);
$sumPage_text = ceil($totalRows_text/$pageSize);
$query_text = "select * from text order by id desc limit {$offset_text},{$pageSize}";
			...
			<div class="container">
                ...
                <div class="col-md-9 right-wrap">
                    ...
                    <ul class="info-list">
                        ...
                        <li class="clearfix">
                            <div class="text-wrap">
                                <h3 class="clearfix"><a href="document_text.php?text_id=<?php echo $admin['id']?>" target="_self"><?php echo $admin['title']?><br></a><span><?php echo $admin['time']?></span></h3>
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_text;$i++){
    					       echo "<li><a href='document_2.php?page_text={$i}'>$i</a></li>";
    					   }echo "<li>第{$page_text}页<li>";
    					?>
    					</ul>
				   </nav>
                </div>
