			...
			<div class="container">
                ...
                <div class="col-md-9 right-wrap">
                    ...
                    <ul class="info-list">
                        ...
                        <li class="clearfix">
                            <div class="text-wrap">
                                <h3 class="clearfix"><a href="document_pro.php?id_pro=<?php echo $admin['id']?>" target="_self"><?php echo $admin['name']?><br></a><span><?php echo $admin['time']?></span></h3>
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_pro;$i++){
    					       echo "<li><a href='document_3.php?page_pro={$i}'>$i</a></li>";
