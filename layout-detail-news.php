...
$query=mysql_query("select * from say where userid = {$news_id} order by id desc limit {$offset_say},{$pageSize}");
                        ...
                        <nav>
        					...
        					<?php
        					   for($i = 1;$i<=$sumPage_say;$i++){
        					       echo "<li><a href='layout-detail-news.php?page_say={$i}&news_id={$news_id}'>$i</a></li>";
