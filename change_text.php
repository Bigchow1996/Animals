...
$query = "select * from say_text where userid = {$text_id} order by id desc limit {$offset_say},{$pageSize}";
        		...
        		<div class="row">
			      ...
			      <div class="col-md-12">
			       <div class='panel panel-default'>
        		    <div class='panel-heading'>修改数据(论文)</div>
            	    <div class='changeCon panel-body'>
            	       <form action='change_data/change_text.php' method='post' target='text' class='form-horizontal' role='form'>
                           <div class='form-group'>
                    ...
                    <nav>
    					...
    					<?php
    					   for($i = 1;$i<=$sumPage_say;$i++){
    					       echo "<li><a href='change_text.php?page_say={$i}&text_id={$text_id}'>$i</a></li>";
            ...
            <script>
            	  $(function(){
        		        $(".delete").click(function(){
            		        ...
            		        var msg = "您真的确定要删除吗？\n\n请确认！";
            		        if (confirm(msg)==true){
            		        	var url = "delect_data/delect_text.php?say_id_text="+id;
                		        $.get(url);
